...
public class MVP {
    ...
    public void printNames(List<String> names) {
        // Implement me :)
        names.stream().forEach(people -> System.out.println(people));
    }
    ...
    */
    ...
    public List<String> splitToAllCapsList(String input) {
        // Implement me :)
        return Arrays.stream(input.split("")).map(el -> el.toUpperCase()).toList();
    }
    ...
    */
    public List<String> filterByFirstLetterAndOrder(List<String> list, String letter) {
        // Implement me :)
        return list.stream()
                .filter(el -> Character.toString(el.charAt(0)).equals(letter))
    ...
    public List<String> filterWords(List<String> words, int maxLength, String firstLetter) {
        ...
        return words.stream()
                .filter(el -> el.length() <= maxLength
                    && Character.toString(el.charAt(0)).equals(firstLetter))
                .toList();
    }
}